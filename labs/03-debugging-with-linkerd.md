...
<img alt="linkerd" src="../images/linkerd-lab03-img01.png" width="60%" height="60%">

3. The first thing you might notice is that the success rate is well below 100%! Click on web and let's dig in

<img alt="linkerd" src="../images/linkerd-lab03-img02.png" width="60%" height="60%">
...
<img alt="linkerd" src="../images/linkerd-lab03-img03.png" width="60%" height="60%">
...
<img alt="linkerd" src="../images/linkerd-lab03-img04.png" width="60%" height="60%">
...
<img alt="linkerd" src="../images/linkerd-lab03-img05.png" width="60%" height="60%">

7. Click on "Start" to start the Tap session

<img alt="linkerd" src="../images/linkerd-lab03-img06.png" width="60%" height="60%">
...
<img alt="linkerd" src="../images/linkerd-lab03-img07.png" width="60%" height="60%">

9. Click the arrow in the left side (marked in orange in the previous image) to see the request details

<img alt="linkerd" src="../images/linkerd-lab03-img08.png" width="60%" height="60%">
